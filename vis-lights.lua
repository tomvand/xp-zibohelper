...
function vis_lights()
    if os.clock() > start_time then
        ...
        --
        -- This script adapts light brightness (exponent) based on time of day and visibility.
        ...
        set("sim/private/controls/lights/dist_far", 1000.0) -- Far side of exponent transition
        ...
        local exp_near = (1.0 - night_ratio) * 0.30 + night_ratio * 0.20 -- day: 0.30, night: 0.20
        local exp_far  = (1.0 - night_ratio) * 0.43 + night_ratio * 0.50 -- day: 0.43, night: 0.50 (very bright)
